  ...
  return (
    <div className=" pt-3 h-20 bg-sky-500 border-t sticky bottom-0 flex items-center justify-between px-8  mx-auto border border-sky-500  shadow-xl sm:w-5/6 md:w-5/6 lg:w-4/6  ">
      ...
      <button className="flex items-center flex-col justify-center">
        ...
        <p className="text-white text-sm">آدرس‌ها</p>
      </button>
      <Link href="/application/order" className="flex items-center flex-col justify-center relative">
        ...
        <div className="size-5 rounded-full text-white flex items-center justify-center bg-sky-700 absolute -top-3 text-sm ">{totalNumber}</div>
      </Link>
    </div>
  );
}
