...
export default function BottomMenu() {
  ...
  return (
    <div className=" pt-3 h-20 bg-sky-500 border-t sticky bottom-0 flex items-center justify-between px-8 z-40 mx-auto border border-sky-500  shadow-xl sm:w-5/6 md:w-5/6 lg:w-4/6 max-[280px]:text-[10px] text-xs sm:text-sm md:text-base ">
