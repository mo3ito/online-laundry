...
const InputPassword = ({
  ...
  useDropDown(
    containerPasswordRef,
    isBoldBorderInputPassword,
    setIsBoldBorderInputPassword
  );
  ...
  return (
    <div className={className}>
      ...
      <div
        ...
        className="border border-sky-500  rounded-lg h-10 flex items-center relative bg-white"
      >
        <input
          id={id}
          ...
          className="w-full h-full outline-none pr-2 pl-10 rounded-lg"
          ref={inputRef}
        />
        {!isShowPassword ? (
          <button
