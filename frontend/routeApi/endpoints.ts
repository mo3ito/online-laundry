...
export const ADMIN_DELETE_MONEY_UNPAID_TO_DRYERS_ORDERS = `${BASE_URL_ADMIN}/delete-money-unpaid-to-dryers-orders`;
export const ADMIN_DELETE_MONEY_PAID_TO_DRYERS_ORDERS = `${BASE_URL_ADMIN}/delete-money-paid-to-dryers-orders`;
