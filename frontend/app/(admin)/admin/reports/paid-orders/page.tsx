...
const {infos} = useAuthContext()
  const {data , isLoading} = useGetReactQuery(infos?._id , "http://localhost:4000/admin/paid-orders",["get all paid orders"])

  return (
    <main>
    <ShowHeaderTitleFixed content="مشتریان" />
    <section className='px-4 w-full h-max pb-10'>
    <ul className="w-full h-max  sm:mt-64 ">
