...
export default function page() {
  return (
    ...
    <QRCodeLinkShower QRCodePath={`${process.env.NEXT_PUBLIC_BASE_URL}`} content='لینک سایت' />
    <QRCodeLinkShower QRCodePath={`${process.env.NEXT_PUBLIC_BASE_URL}/application`} content='لینک اپلیکیشن' />
    </main>
  )
}
